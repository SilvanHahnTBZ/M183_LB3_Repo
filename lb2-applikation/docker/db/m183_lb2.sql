...
insert into users (ID, username, password) values (1, 'admin1', '$2b$10$/cPX2FlAg3iPOjFB/7lDc.kwZy6aW7XavYXo26qkUJu0nW4TMlkgO');
insert into users (ID, username, password) values (2, 'user1', '$2b$10$rDZhuPXyH8dwlM1Z2YKRwOVxc/kvo2RIaGkmzvNg9ui4uoh4my0g6');
